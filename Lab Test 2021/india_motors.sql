...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`IndiaMoters` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `customers` (
  ...
  `salesRepEmpID` int(11) DEFAULT NULL,
  `creditLimit` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`customerID`),
  KEY `salesRepEmpID` (`salesRepEmpID`),
  CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`salesRepEmpID`) REFERENCES `employees` (`employeeID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `customers` */

insert  into `customers`(`customerID`,`customerName`,`contactLastName`,`contactFirstName`,`phone`,`addressLine1`,`addressLine2`,`city`,`state`,`postalCode`,`country`,`salesRepEmpID`,`creditLimit`) values 
...
insert  into `employees`(`employeeID`,`lastName`,`firstName`,`extension`,`email`,`officeCode`,`reportsTo`,`jobTitle`) values 
...
insert  into `orderdetails`(`orderID`,`productCode`,`quantityOrdered`,`priceEach`,`orderLineNumber`) values 
...
insert  into `orders`(`orderID`,`orderDate`,`requiredDate`,`shippedDate`,`status`,`comments`,`customerID`) values 
...
insert  into `productType`(`type`,`textDescription`,`htmlDescription`,`image`) values 
...
CREATE TABLE `products` (
  ...
  KEY `type` (`type`),
  CONSTRAINT `products_ibfk_1` FOREIGN KEY (`type`) REFERENCES `productType` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `products` */

insert  into `products`(`productCode`,`productName`,`type`,`productScale`,`productVendor`,`productDescription`,`quantityInStock`,`buyPrice`,`MSRP`) values 

('S18_1988','Collectable Wooden Train','Trains','1:18','Red Start Diecast','Hand crafted wooden toy train set is in about 1:18 scale, 25 inches in total length including 2 additional carts, of actual vintage train. This antique style wooden toy train model set is all hand-assembled with 100% wood.',6450,'67.56','100.84'),
